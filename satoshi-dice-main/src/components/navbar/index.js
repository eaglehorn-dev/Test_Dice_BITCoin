...
export default function Navbar() {
    ...
    return (
        <nav className="w-full bg-black py-1">
            {showHowToPlay && (
            ...
            <div className="hidden md:flex items-center justify-center gap-8 py-6">
                ...
                <div className="flex items-center gap-3">
                    <Link href="/">
                        <img src="/assets/bitcoin-logo.svg" className="h-12" suppressHydrationWarning alt="Bitcoin Dice" />
                    </Link>
                    <Link href="/">
                        <span className="text-white text-xl font-semibold">Bitcoin Dice</span>
                    </Link>
                </div>
            ...
            <div className="md:hidden flex items-center justify-between px-4 py-4">
                <div className="flex items-center gap-2">
                    <img src="/assets/bitcoin-logo.svg" className="h-8" suppressHydrationWarning alt="Bitcoin Dice" />
                    <span className="text-white text-lg font-semibold">Bitcoin Dice</span>
                </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70">
            <div className="relative w-full max-w-2xl mx-4 rounded-xl bg-black p-8 text-white border border-[#FF8C00]/20">
                ...
                <h1 className="text-center text-4xl font-semibold mb-10">
                    Win massive amounts of <br /> <span className="text-[#FF8C00]">Bitcoin</span>
                </h1>
                ...
                <div className="space-y-10">
                    ...
                    <div className="flex items-start gap-5">
                        ...
                        <div>
                            ...
                            <p className="text-lg">
                                Send Bitcoin to an address below to place a bet.
                            </p>
